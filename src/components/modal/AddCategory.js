                ...
                {/* <form> */}
                    <div className="mt-4">
                        <div className='my-3 text-left'>
                            <label className="text-gray-700">Masukan Kategori</label>
                            <div className='flex flex-row mt-2'>
                                <input id="passwordConfirmation" type="file" placeholder='upload icon kategory' className="w-5/6 px-4 py-2 mx-1 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring" />
                        ...
                        <div>
                            <p className='m-3'>List Kategori</p>
