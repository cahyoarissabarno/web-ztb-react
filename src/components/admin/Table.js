...
export default function Table(props) {
    ...
    return (
        <>
            {/* <div className={`${toggleModal ? 'flex' : 'none'} absolute z-10 w-full`}>
                ...
                <div className="py-8">
                    <div className="grid md:grid-cols-2 auto-rows-auto md:w-full">
                        <div className="grid grid-cols-2 auto-rows-auto justify-self-start">
                            ...
                            <button onClick={()=>props.toggle(!props.tg)} className="flex-shrink-0 px-4 py-2 text-base font-semibold text-white bg-purple-600 rounded-lg shadow-md hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-purple-200" type="submit">
                                + Add Product
                            </button>
                        </div>
