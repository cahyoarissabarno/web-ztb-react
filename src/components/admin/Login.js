...
export default function Login(props) {
    return (
        <div className="w-full px-4 h-screen font-sans bg-cover bg-landscape" style={{ backgroundImage: "url('/images/bg-blue-newww.webp')" }}>
            <div className="container flex items-center justify-center flex-1 h-full mx-auto">
                <div className="w-full max-w-lg">
                    <div className="leading-loose">
                        <form className="max-w-sm p-10 m-auto bg-white bg-opacity-25 rounded shadow-xl">
                            <img className="w-full h-10 object-cover mx-auto my-6 relative" src='/images/logo-white.png' />
